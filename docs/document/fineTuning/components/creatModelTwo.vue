<template>
  <el-tabs v-model="creatModelTwo_activeName" class="demo-tabs">
    <el-tab-pane label="Python" name="Python">
      <div>
       <MarkdownRender :source="creatModelTwo_python" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
      <MarkdownRender :source="creatModelTwo_node" />
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
...
import creatModelTwo from '../hooks/creatModelTwo'
import {ElTabs,ElTabPane} from "element-plus";
const { creatModelTwo_activeName,creatModelTwo_node,creatModelTwo_python } = creatModelTwo();
