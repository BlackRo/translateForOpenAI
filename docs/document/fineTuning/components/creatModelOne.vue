<template>
  <el-tabs v-model="creatModelOne_activeName" class="demo-tabs">
    <el-tab-pane label="Python" name="Python">
      <div>
       <MarkdownRender :source="creatModelOne_python" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
      <MarkdownRender :source="creatModelOne_node" />
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
...
import creatModelOne from '../hooks/creatModelOne'
import {ElTabs,ElTabPane} from "element-plus";
const { creatModelOne_activeName,creatModelOne_node,creatModelOne_python } = creatModelOne();
