<template>
  <el-tabs v-model="editImage_activeName" class="demo-tabs">
    <el-tab-pane label="Python" name="Python">
      <div>
       <MarkdownRender :source="editImage_python" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
      <MarkdownRender :source="editImage_node" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="curl" name="curl">
      <div class="stepcontent">
      <MarkdownRender :source="editImage_curl" />
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
...
const { editImage_activeName,editImage_node,editImage_python,editImage_curl } = editImage();
