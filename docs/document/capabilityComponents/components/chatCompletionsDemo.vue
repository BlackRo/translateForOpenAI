<template>
  <el-tabs v-model="activeName" class="demo-tabs">
    <el-tab-pane label="Curl" name="Curl">
      <div class="py_demo1">
        <MarkdownRender :source="curl_chatAPI" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Python" name="Python">
      <div>
       <MarkdownRender :source="python_chatAPI" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
      <MarkdownRender :source="node_chatAPI" />
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
...
const { curl_chatAPI,activeName,python_chatAPI,node_chatAPI } = chatAPI();
</script>
<style >
.py_demo1 {
  background: #aaa;
