<template>
  <el-tabs v-model="embeddingsGet_markdown_activeName" class="demo-tabs">
    <el-tab-pane label="curl" name="curl">
      <div>
        <MarkdownRender :source="embeddingsGet_curl" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Python" name="Python">
      <div>
        <MarkdownRender :source="embeddingsGet_python" />
      </div>
    </el-tab-pane>
    <!-- <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
        <MarkdownRender :source="embeddingsGet_node" />
      </div>
    </el-tab-pane> -->
  </el-tabs>
</template>
...
import embeddingsGet from "../hooks/embeddingsGet";
import {
  ElTabs,
  ElTabPane,
} from "element-plus";
