<template>
  <el-tabs v-model="addMessage_activeName" class="demo-tabs">
    <el-tab-pane label="Python" name="Python">
      <div>
       <MarkdownRender :source="addMessage_python" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="Node.js" name="Node">
      <div class="stepcontent">
      <MarkdownRender :source="addMessage_node" />
      </div>
    </el-tab-pane>
    <el-tab-pane label="curl" name="curl">
      <div class="stepcontent">
      <MarkdownRender :source="addMessage_curl" />
      </div>
    </el-tab-pane>
  </el-tabs>
</template>
...
const { addMessage_activeName,addMessage_python,addMessage_curl,addMessage_node } = addMessage();
